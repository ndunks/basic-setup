...
static webfs_t const web_files[] = {
    ...
    {.name = "index-bff18c79.js", .type = web_mime_application_javascript, .gzip = true, .offset = 772, .size = 97243},
    {.name = "index-ed2142d7.css", .type = web_mime_text_css, .gzip = true, .offset = 98015, .size = 40736},
    {.name = "index.html", .type = web_mime_text_html, .gzip = true, .offset = 138751, .size = 283}};

#define INDEX_HTML_OFS 3
#define WEB_FILE_NAME_MAX 18
    // Total size: 139034 bytes
    // Generated at 12/7/2024, 3:12:12 PM
/* GENERATED CODE END */
#endif