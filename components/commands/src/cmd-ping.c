...
static esp_err_t ping_result_code;
...
static void cmd_ping_on_ping_end(esp_ping_handle_t hdl, void *args)
{
    ...
    ping_result_code = transmitted - received;
    // Resume terminal task
    vTaskResume(terminal_task_handle);
}
